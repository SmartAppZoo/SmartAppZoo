...
* Added range limits for the Alarm and Lightaction type values.
*
* 4/29/2018 v1.0.1
...
switch (evt.value)
    ...
    log.debug "$evt.name:$evt.value, pushAndPhone:$pushAndPhone, '$msg'"
        ...
        log.debug "Found device: ID: ${it.id}, Label: ${it.label}, Name: ${it.name}, Is Motion Event"
