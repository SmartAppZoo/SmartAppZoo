definition(
    name: "Magic Cube Button Controller",
    namespace: "SteveTheGeekHA",
    author: "Steve The Geek, using code from Matt Frank and Brian Dahlem",
    description: "Magic Cube Button Assignment App",
...
def selectButton() {
  dynamicPage(name: "selectButton", title: "First, select which Magic Cube", nextPage: "configureButton1", uninstall: configured()) {
    section {
...
def configureButton1() {
  dynamicPage(name: "configureButton1", title: "When the cube is shaked, what do you want it to do?",
    nextPage: "configureButton2", uninstall: configured(), getButtonSections(1))

}

def configureButton2() {
  dynamicPage(name: "configureButton2", title: "When the cube is flipped 90 degrees, what do you want it to do?",
    nextPage: "configureButton3", uninstall: configured(), getButtonSections(2))
}

def configureButton3() {
  dynamicPage(name: "configureButton3", title: "When the cube is flipped 180 degrees, what do you want it to do?",
    nextPage: "configureButton4", uninstall: configured(), getButtonSections(3))
}
def configureButton4() {
  dynamicPage(name: "configureButton4", title: "When the cube is slid, what do you want it to do?",
    nextPage: "configureButton5", uninstall: configured(), getButtonSections(4))
}
def configureButton5() {
  dynamicPage(name: "configureButton5", title: "When the cube is knocked, what do you want it to do?",
    nextPage: "configureButton6", uninstall: configured(), getButtonSections(5))
}
def configureButton6() {
  dynamicPage(name: "configureButton6", title: "When the cube is rotated left, what do you want it to do?",
    nextPage: "configureButton7", uninstall: configured(), getButtonSections(6))
}
def configureButton7() {
  dynamicPage(name: "configureButton7", title: "When the cube is rotated right, what do you want it to do?",
