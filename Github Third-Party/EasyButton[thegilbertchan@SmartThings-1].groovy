...
preferences {
        ...
        section("When this switch is pushed") {
			input "easyButton",  "capability.momentary", title: "Which Switch?"
		}
        section("Speak this phrase"){
         input "message", "text", title: "Notification message", description: "That was easy!", required: true
        }
...
def initialize() {
    ...
    subscribe(easyButton, "momentary.pushed", onHandler)
}
