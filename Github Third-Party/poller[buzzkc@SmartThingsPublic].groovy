/**
 *  Poller - The SmartThings Polling Daemon.
 *
 *  Poller works behind the scenes and periodically calls 'poll' or
 ...
 *
 *  Please visit [https://github.com/buzzk/smartthings] for more
 *  information. 
 *
 *  --------------------------------------------------------------------------
 *  Copyright © 2016 buzzkc.com
 *
...
definition(
    ...
    iconX3Url: "http://cdn.device-icons.smartthings.com/Health%20&%20Wellness/health7-icn@2x.png")

preferences {
    section("About") {
        def hrefAbout = [
            url:        "http://buzzkc.github.io/smartthings/",
            style:      "embedded",
            title:      "Tap for more information...",
            description:"http://buzzkc.github.io/smartthings/",
            required:   false
        ]
...
private def initialize() {
    log.info "Poller. Version ${version()}. ${copyright()}"
...
private def restart() {
    //sendNotification("Poller stalled. Restarting...")
    updated()
}
