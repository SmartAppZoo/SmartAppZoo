 ...
 *	2. Jason Ziemba
 *	2015-02-26: Added capability.sensor device picker and sensor.active event subscription. For pressure sensor.
 */
definition(
    name: "Notify Me When",
...
preferences {
	section("Choose one or more, when..."){
    	input "sensor", "capability.sensor", title: "Sensor Active", required: false, multiple: true //jz
...
def subscribeToEvents() {
	...
	subscribe(sensor, "sensor.active", eventHandler) //jz
