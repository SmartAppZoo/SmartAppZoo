 ...
 */
 ...
 Changes [June 6th, 2017]
    ...
    - Added Autodiscover for Security Panel DeviceID
...
definition(
    name: "TotalConnect v0.4",
    namespace: "Security",
    author: "Yogesh Mhatre",
    description: "Total Connect App to lock/unlock your home based on your location and mode.  No device created/needed",
    category: "My Apps",
...
preferences {
    ...
    page(name: "locationList", title: "Select the Total Connection Location for this App", content:"locationList")

}

// Start of Page Functions
private locationList(){
	dynamicPage(name:"locationList", title:"Pulling up the Location List!", install: true, uninstall: true) {
        ...
        section("Backend TotalConnect 2.0 Values - DO NOT CHANGE") {
...
Map getDeviceIDs(targetLocationId) {
    ...
    log.debug "Smart Things has logged In to get DeviceIDs. SessionID: ${token}"   
