 ...
 *  Author: Doug Dale
 *
 *  Based largely on the SmartThings Smart Nightlight code, but modified to get sunrise/sunset times differently
 *  and (hopefully) more reliably.
 *
 */
definition(
    name: "Smart(er) Nightlight",
    namespace: "dougdale",
    author: "Doug Dale",
    description: "Turns on lights when it's dark and motion is detected. Turns lights off when it becomes light or some time after motion ceases. Based on Smart Nightlight by SmartThings with modified method for sunrise/sunset determination.",
