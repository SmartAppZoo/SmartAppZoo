...
def setupMonitoring()
{
    ...
    dynamicPage(name: "setupMonitoring", nextPage: "setupName", uninstall: true) 
    {
        ...
        {
            input "lights", "capability.switchLevel", required: true, multiple: true
            input(name: "dimmerLevel", type: "number", range: "1..100", defaultValue: "100", title: "Level to dim lights (1-100)")
        }
        ...
        {
            input(name: "seconds", type: "number", defaultValue: 0, title: "Seconds")
        }
