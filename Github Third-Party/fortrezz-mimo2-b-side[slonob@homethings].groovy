...
definition(
    ...
    namespace: "slonob",
    author: "FortrezZ, LLC and Jarrod Stenberg",
    description: "Breaks the MIMO2 into two separate devices to allow automation on SIG2 and Relay 2.  Modified for better performance.",
...
//    	subscribe(it, "currentValue", events)
