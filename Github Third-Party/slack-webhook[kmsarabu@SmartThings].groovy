...
definition(
    ...
    category: "My Apps",
    iconUrl: "https://vignette.wikia.nocookie.net/logopedia/images/9/9d/SmartThings.png",
    iconX2Url: "https://vignette.wikia.nocookie.net/logopedia/images/9/9d/SmartThings.png"
)
...
def eventHandler(evt) {
  log.debug location.currentMode
  if (location.currentMode == "Away") {
  log.debug "${evt.name}, ${evt.value}, ${location.currentMode}, ${location.id}, ${location.hubs*.id}, ${location.mode}, ${location.name}"
  
  def json_body = '''{
      "text": "Location : ''' + "${location.name}\n Alarm Triggered By Device ${evt.device} ${evt.name} ${evt.value} @ ${evt.date}" + '''",
      "username": "SmartThings",
      "icon_url": "https://vignette.wikia.nocookie.net/logopedia/images/9/9d/SmartThings.png"
  }'''
  //log.debug json_body
