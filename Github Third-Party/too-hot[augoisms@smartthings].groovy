 ...
 *  Too Hot
 *
 * based on https://github.com/SmartThingsCommunity/SmartThingsPublic/blob/master/smartapps/smartthings/its-too-hot.src/its-too-hot.groovy
 *
 *  Author: augoisms
 */
definition(
    ...
    namespace: "augoisms",
    author: "augoisms",
    description: "Monitor the temperature and turn on an A/C unit in a particular zone.",
...
preferences {
	...
	section("When the temperature rises above...") {
		input "tempOn", "number", title: "On Temperature?"
	}
    section("Turn off when the temperature drop below...") {
		input "tempOff", "number", title: "Off Temperature?"
	}
