...
*
* Copyright 2017 Dennis Somerville
*
...
*/
definition(
name: "ElasticSearch HTTP Event Logger",
namespace: "densom",
author: "Dennis Somerville",
description: "Log SmartThings events to an ElasticSearch server",
...
def http_protocol
def splunk_server = "${elastic_host}:${elastic_port}"
...
def params = [
uri: "${http_protocol}://${elastic_host}:${elastic_port}/${index_name}",
headers: [ 
'Authorization': "Basic ${auth_token}" 
],
body: json
