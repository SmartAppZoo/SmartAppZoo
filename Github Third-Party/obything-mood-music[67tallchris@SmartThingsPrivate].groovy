...
preferences {
  page(name: "mainPage", title: "Choose the triggers", nextPage: "chooseTrackAndSpeakers", uninstall: true)
  page(name: "chooseTrackAndSpeakers", title: "Choose the playlist and speakers", install: true, uninstall: true)
  // page(name: "chooseTrack", title: "Select a playlist", nextPage: "chooseSpeakers", uninstall: true)
  // page(name: "chooseSpeakers", title: "Select speakers", install: true, uninstall: true)
...
private takeAction(evt) {
  ...
  if (evt.value == "on")
  {
      ...
      obything.playPlaylist(playlist, speakerString, volume)
  }
  else
  {
  	obything.pause()
