...
definition(
    name: "Lighting Director Enhanced",
    namespace: "marqelme",
    author: "Tim Slagle & Michael Struck (modified by Marc Tschapek)",
...
def pageSetupScenarioA() {
    ...
    def inputColorsA = [
        ...
        title: "Control the following color bulb...",
		required: false,
        multiple:   true,
		hideWhenEmpty: true
    ]
    ...
    def inputColorsHueA = [
        name:       "A_colorsHue",
        type:       "number",
        title: "Set this hue for the color bulbs (0-100)...", 
        range: "0..100",
        required: false,
        defaultValue: "50"
    ]
    ...
    def inputColorsSatA = [
        name:       "A_colorsSat",
        type:       "number",
        title: "Set this saturation for the color bulbs (0-100)...", 
        range: "0..100",
        required: false,
        defaultValue: "50"
    ]
    ...
    def inputTempsA = [
        ...
        title: "Control the following temperature bulb...", 
        hideWhenEmpty: true,
        multiple:   true,
        required:   false
    ]

    def inputColorTempsA = [
        name:       "A_tempscolor",
        type:       "number",
        title: "Set this temperature (Kelvin) for the temp bulbs (2700-6500)...", 
        range: "2700..6500",
        required: false,
        defaultValue: "3400"
    ]
    ...
    return dynamicPage(pageProperties) {
        ...
        section("Scenario settings") {
            		input inputColorsHueA
                    input inputColorsSatA
            		input inputColorTempsA
                    input inputLevelA
...
def delayTurnOffA(){
    //settings.A_dimmers?.setLevel(10)
	settings.A_switches?.off()
	state.A_timerStart = false
	if (state.A_triggered) {
    	runOnce (getMidnight(), midNightReset)
...
private def helpText() {
	def text =
        ...
        "Each scenario can control dimmers, switches, color and temperature bulbs but can also be " +
        ...
        "If you choose a color bulb and the same bulb as a temperature bulb at the same scenario " +
        "the hue and saturation values will overwrite the temperature values."
	text
}
