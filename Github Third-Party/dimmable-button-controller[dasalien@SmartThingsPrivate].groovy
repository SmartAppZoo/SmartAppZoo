 ...
 */
definition(
    name: "Dimmable Button Controller",
    namespace: "dasalien",
...
def getButtonSections(buttonNumber) {
	return {
		...
		section("Dim Down") {
			...
			input "dimmerlower_${buttonNumber}_held", "capability.switchLevel", title: "Held", multiple: true, required: false
		}
		section("Locks") {
...
def executeHandlers(buttonNumber, value) {
	...
	def dimmerlower = find('dimmerlower', buttonNumber, value)
