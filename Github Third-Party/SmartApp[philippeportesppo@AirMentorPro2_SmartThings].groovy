 ...
 *  2017-03/09: Philippe Portes added CO2 device type and Air Mentor Pro 2 event management.
 */
definition(
		name: "Notify Me When",
...
preferences {
	section("Choose one or more, when..."){
        ...
        // Added to original Notify Me to include Air Mentor Pro 2 
        input "co2", "capability.carbonDioxideMeasurement", title: "C02 Sensor", required: false, multiple: true
...
def subscribeToEvents() {
    ...
    // Added to original Notify Me When
    subscribe(co2, "IAQ", eventHandler)
    subscribe(co2, "CO2", eventHandler)
    subscribe(co2, "PM2_5", eventHandler)    
    subscribe(co2, "PM10", eventHandler) 
    subscribe(co2, "TVOC", eventHandler)
