 ...
 */
definition(
    name: "17355DirectConflict2",
    namespace: "yifeiy3",
    author: "Eric Yang",
    description: "Switch 3 off implies Switch 2 on",
    category: "",
...
preferences {
    ...
    section("Put this switch for reference..."){
    	input "switchref", "capability.switch", required:true
    }
}
