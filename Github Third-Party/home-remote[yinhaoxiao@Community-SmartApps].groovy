...
preferences {
	...
	input "buttonGroup", "capability.button",title: "Buttone", multiple: true, required: false
	...
	//input "configurations", "capability.configuration",title: "", multiple: true, required: false
	...
	//input "notifications", "capability.notification",title: "", multiple: true, required: false
	//input "pollings", "capability.polling",title: "", multiple: true, required: false
	...
	input "speechSyntheses", "capability.speechSynthesis",title: "Speech Synthesysers", multiple: true, required: false
	//input "stepSensors", "capability.stepSensor",title: "", multiple: true, required: false
	...
	//input "tones", "capability.tone",title: "", multiple: true, required: false
