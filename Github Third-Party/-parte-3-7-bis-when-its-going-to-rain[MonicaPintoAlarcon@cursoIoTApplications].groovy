...
definition(
    name: "(Parte 3) 7.bis When It's Going to Rain",
...
def scheduleCheck() {
    ...
    def count = sensors.count { it?.latestValue("contact") == 'open' }
    ...
    //Codigo para probar otros valores del primer parámetro 
    def response2 = getWeatherFeature("conditions",zipcode)
    log.debug "Weather: $response2"
}
