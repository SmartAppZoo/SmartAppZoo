...
preferences {
    ...
    section("Your geonameid") {
        input "geonameid", "text", title: "geonameid", required:true
    }
...
def pushMessage
def testmessage
def urlRequest = "https://www.hebcal.com/hebcal/?v=1&cfg=json&nh=off&nx=off&year=now&month=now&mf=off&c=on&geo=geoname&zip=&city=&geonameid=${geonameid}&m=${havdalahOffset}&s=off&D=off&d=off&o=off&ss=off"
