/**
 *  Lights with dimmable switch or bulb-child SmartApp for SmartThings
 *
 *  Copyright 2020
 *
...
definition(
	name: "Lights with dimmable switch or bulb-child",
	namespace: "mST/child",
...
def mainSettingsPage() {
	...
	name: 		"mainSettingsPage", 
		...
		section("Control these dimmable switches") {
			input (
				name:		"switches", 
...
def restartVerifictionSchedule() {
	...
	//sendPushMessage('Smart Front Ligt schedule failed and has been restarted')
}
