/**
 *  SC Battery Full Alert
 *
 *  Copyright 2014 SoonChye
 *
...
definition(
    ...
    namespace: "ScBatteryFullAlert",
    author: "SoonChye",
    description: "Get notified when you battery is fully charged",
...
/*
    ...
    if (meterValue > aboveThresholdValue) {
    	if (lastValue < aboveThresholdValue) { // only send notifications when crossing the threshold
		    def msg = "${meter} reported ${evt.value} W which is above your threshold of ${aboveThreshold}."
    	    sendMessage(msg)
        } else {
