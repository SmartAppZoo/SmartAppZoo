...
definition(
    ...
    namespace: "evennink",
    author: "Erik Vennink",
    description: "Connect to Hue Groups (defined with HUE API)",
...
def locationHandler(evt) {
	...
	{ // HUE BRIDGE RESPONSES
		...
		{ //(application/json)
			...
			{ //GET /api/${state.username}/groups response (application/json)
...
private polling() {
	def uri = "/api/${state.username}/groups/"
	log.debug "GET:  $uri"
